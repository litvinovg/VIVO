 ...
 */
public class AddExternalAuthorsToInformationResourceGenerator extends VivoBaseGenerator implements
    ...
    public void setUrisAndLiteralsOnForm(EditConfigurationVTwo editConfiguration, VitroRequest vreq) {
        ...
        List<String> literalsOnForm = list(
            "firstName",
            "middleName",
            "lastName",
            "rank",
    ...
    private static String AUTHORSHIPS_QUERY = " \n"
        ...
        + "PREFIX foaf: <http://xmlns.com/foaf/0.1/> \n"
        + "PREFIX vcard:  <http://www.w3.org/2006/vcard/ns#> \n"
        + "SELECT ?authorshipURI"
        + " (REPLACE(STR(?authorshipURI),\"^.*(#)(.*)$\", \"$2\") AS ?authorshipName)"
        + " ?authorURI"
        + " ?authorName"
        + " ?rank \n"
        + "WHERE { { \n"
