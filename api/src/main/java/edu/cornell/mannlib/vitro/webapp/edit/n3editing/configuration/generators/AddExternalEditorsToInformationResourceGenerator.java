 ...
 */
public class AddExternalEditorsToInformationResourceGenerator extends VivoBaseGenerator implements
    ...
    public void setUrisAndLiteralsOnForm(EditConfigurationVTwo editConfiguration, VitroRequest vreq) {
        ...
        List<String> literalsOnForm = list("firstName", "middleName", "lastName", "rank", "label");
