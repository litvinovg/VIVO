 ...
 */
public class AddExternalEditorsOrgsToInformationResourceGenerator extends VivoBaseGenerator implements
    ...
    private String getN3EditorshipRank() {
        return getN3PrefixString() + "?editorshipUri core:rank ?rank .";
    }
    ...
    private void setUrisAndLiteralsInScope(EditConfigurationVTwo editConfiguration, VitroRequest vreq) {
        ...
        urisInScope.put(editConfiguration.getVarNameForSubject(), Arrays.asList(new String[] {
                editConfiguration.getSubjectUri() }));
        urisInScope.put(editConfiguration.getVarNameForPredicate(), Arrays.asList(new String[] {
                editConfiguration.getPredicateUri() }));
    ...
    private static String EDITORSHIPS_QUERY = " \n"
        ...
        + "PREFIX foaf: <http://xmlns.com/foaf/0.1/> \n"
        + "PREFIX vcard: <http://www.w3.org/2006/vcard/ns#> \n"
        + "SELECT ?editorshipURI"
        + " (REPLACE(STR(?editorshipURI),\"^.*(#)(.*)$\", \"$2\") AS ?editorshipName)"
    ...
    public class EditorshipInfo {
        ...
        public EditorshipInfo(String inputEditorshipUri, String inputEditorshipName, String inputEditorUri,
